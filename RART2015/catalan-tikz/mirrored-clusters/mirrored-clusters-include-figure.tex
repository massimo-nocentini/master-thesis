...
\begin{figure}[p]
    ...
    \noindent\makebox[\textwidth]{
        ...
        \includegraphics[width=10cm, height=10cm, keepaspectratio=true]{catalan-tikz/mirrored-clusters/mirrored-clusters.pdf}
    }
    ...
    \caption[.]{$\hat{d}_{20,2^{4}-1}$, congruences
        $d_{20-e,2^{4}-1-e} \equiv_{2} d_{20,2^{4}-1+e}$ 
