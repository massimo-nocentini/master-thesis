...
\begin{frame}{On $\mathcal{P}_{\equiv_{p}}$ and $\mathcal{P}_{\equiv_{p}}^{-1}$}
    ...
    \input{pascal-tikz/zero-holes/zero-holes-include-figure}
\end{frame}
...
\begin{frame}{On $\mathcal{P}_{\equiv_{p}}$ and $\mathcal{P}_{\equiv_{p}}^{-1}$}
    ...
    \input{pascal-tikz/multiples-over-antidiagonal/multiples-over-antidiagonal-include-figure}
\end{frame}
...
\begin{frame}{On $\mathcal{C}_{\equiv_{2}}$}
    ...
    \input{catalan-tikz/odd-row/odd-row-include-figure}
\end{frame}
...
\begin{frame}{On $\mathcal{C}_{\equiv_{2}}$}
    ...
    \input{catalan-tikz/mirror-segment/mirror-segment-include-figure}
...
\begin{frame}{On $\mathcal{C}_{\equiv_{2}}$}
    ...
    \input{catalan-tikz/mirrored-clusters/mirrored-clusters-include-figure}
...
\begin{frame}{On $\mathcal{C}_{\equiv_{2}}$}
    ...
    \input{catalan-tikz/principal-cluster/principal-cluster-include-figure}
...
\begin{frame}{On $\mathcal{C}_{\equiv_{2}}$}
    ...
    \input{catalan-tikz/zero-hole/zero-hole-include-figure}
...
\begin{frame}{Summary}
  ...
  \begin{itemize}
      ...
      \item some properties about $\mathcal{P}$ and $\mathcal{P}^{-1}$
      \item a modular characterization of $\mathcal{C}$
  \end{itemize}
  ...
  \item
    Open problems:
    \begin{itemize}
    \item what about a modular characterization of $\mathcal{F},\mathcal{M},\mathcal{D}$?
    \item is there a way to build proofs using functions $d$ and $h$, without
        extracting coefficients to the rescue? 
    \end{itemize}
  \end{itemize}
\end{frame}
