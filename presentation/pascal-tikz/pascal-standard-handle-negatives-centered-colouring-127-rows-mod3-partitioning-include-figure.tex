...
\begin{figure}[p]
    ...
    \noindent\makebox[\textwidth]{
        ...
        \includegraphics[width=20cm, height=20cm, keepaspectratio=true]{../sympy/pascal/pascal-standard-handle-negatives-centered-colouring-127-rows-mod3-partitioning-triangle.pdf}
    }
