...
\begin{figure}[p]
    ...
    \noindent\makebox[\textwidth]{
        ...
        \includegraphics[width=5cm, height=5cm, keepaspectratio=true]{pascal-tikz/main-idea-four-splitted/centered-numbers.pdf}
    }
    ...
    \label{fig:main:idea:centered:numbers}
