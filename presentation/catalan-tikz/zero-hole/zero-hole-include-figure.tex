...
\begin{figure}[p]
    ...
    \noindent\makebox[\textwidth]{
        ...
        \includegraphics[width=10cm, height=10cm, keepaspectratio=true]{catalan-tikz/zero-hole/zero-hole.pdf}
    }
    ...
    \caption[.]{Zero hole $\mathcal{T}_{\equiv_{2}0} \subset \mathcal{C}^{(5)}$}
