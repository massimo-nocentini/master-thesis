...
\begin{figure}[p]
    ...
    \noindent\makebox[\textwidth]{
        ...
        \includegraphics[width=6cm, height=6cm, keepaspectratio=true]{catalan-tikz/principal-cluster/principal-cluster.pdf}
    }
    ...
    \caption[.]{$\hat{d}_{s,2^{3}-1}$ for $s\in S_{2^{3}-1}$,
