...
%    plus/.style={text=links,font=\footnotesize\bfseries\sffamily},
  ...
  % the following key `catalan-traditional-standard-handle-negatives-centered-colouring-127-rows-multiples-of-2-partitioning-tikz-nodes.tex' is used as a template key
  % to allow Python to do string substitution
  \input{catalan-traditional-standard-handle-negatives-centered-colouring-127-rows-multiples-of-2-partitioning-tikz-nodes.tex}
\end{tikzpicture}
