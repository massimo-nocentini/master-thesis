...
\begin{document}
    ...
    function $g$ in $h(t)$ (very important to understand: here $h(t)$ shouldn't be
    interpreted as a \emph{function} from the definition of $\mathcal{R}$, instead
    ...
    \begin{displaymath}
        ...
        \mathcal{R}_{\hat{h}(t)}\left(k(\hat{h}(t)),\hat{h}(t)\right)
    \end{displaymath}
    where $k(y)=\frac{1}{g(h(y))}$, therefore we got a new array factored respect $\hat{h}(t)$.
    ...
    \begin{itemize}
        \item let $\mathcal{R}_{h(t)}=\left(g(h(t)), h(t)\right)$ a factorization of $\mathcal{R}$,
            ...
            \begin{displaymath}
                \begin{split}
                    \big[ g_{\mathcal{D}}(y) &= 1 + 1 y + - y^{2} + 3 y^{3} + -11y^{4} + 45 y^{5} + -197y^{6}\\ 
