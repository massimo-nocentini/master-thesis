...
\begin{document}
    ...
    \begin{displaymath} 
        \hat{h}(y) = y - y^2
    \end{displaymath} 
    so $f(y)=d(\hat{h}(1+y))=\frac{1}{1+y}$ therefore:
    \begin{displaymath} 
        \mathcal{C}_{y=h(t)-1}\left( \frac{1}{1+y}, 1+y \right) = 
            \mathcal{C}_{h(t)}\left( \frac{1}{h(t)}, h(t) \right)
    \end{displaymath} 
    Now study the generating function which carries coefficients lying on column $k$
    of $\mathcal{C}_{h(t)}$:
    \begin{displaymath} 
    ...
    This characterize the generic column $k$: first column has index $j$ solution of
    $j-1=0$, therefore coefficients lying on it can be read on the generating function:
    \begin{displaymath} 
        h(t)
    \end{displaymath} 
    just for completeness, second column has index $j$ solution of
    $j-1=1$, therefore coefficients lying on it can be read on the generating function:
    \begin{displaymath} 
        h(t)^2
    \end{displaymath} 
    and so on...
    ...
    \end{displaymath} 
    so $f(y)=d(\hat{h}(1+y))=\frac{3+3y+y^2}{1+2y+y^2}$ therefore:
    \begin{displaymath} 
        \mathcal{M}_{y=h(t)-1}\left( \frac{3+3y+y^2}{1+2y+y^2}, 1+y \right) = 
            \mathcal{M}_{h(t)}\left( \frac{1+h(t)+h(t)^2}{h(t)^2}, h(t) \right) 
    \end{displaymath} 
    Now study the generating function which carries coefficients lying on column $k$
    of $\mathcal{M}_{h(t)}$:
    \begin{displaymath} 
        h(t)^{k-2}+h(t)^{k-1}+h(t)^{k}
    \end{displaymath} 

    This characterize the generic column $k$: first column has index $j$ solution of
    $j-2=0$, therefore coefficients lying on it can be read on the generating function:
    \begin{displaymath} 
        1+h(t)+h(t)^{2}
    \end{displaymath} 
    just for completeness, second column has index $j$ solution of
    $j-2=1$, therefore coefficients lying on it can be read on the generating function:
    \begin{displaymath} 
        h(t)+h(t)^2+h(t)^{3}
    \end{displaymath} 
    and so on...
    ...
    \begin{displaymath} 
        \hat{h}(y) = \frac{y}{1+y+y^2}
    \end{displaymath} 
    so $f(y)=d(\hat{h}(1+y))=\frac{3+3y+y^2}{2y+y^2}$ therefore:
    \begin{displaymath} 
        \mathcal{T}_{y=h(t)-1}\left( \frac{3+3y+y^2}{2y+y^2}, 1+y \right) = 
            \mathcal{T}_{h(t)}\left( \frac{1+h(t)+h(t)^2}{h(t)^2 -1}, h(t) \right) 
    \end{displaymath} 
    Now study the generating function which carries coefficients lying on column $k$
    of $\mathcal{T}_{h(t)}$:
    \begin{displaymath} 
        \frac{h(t)^k+h(t)^{k+1}+h(t)^{k+2}}{h(t)^2 -1}
    \end{displaymath} 
    This is quite strange since the series expansion has all coefficient negated
    respect the classical version obtained by normal definition for $\mathcal{T}$.
