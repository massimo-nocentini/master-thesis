...
\begin{document}
    ...
    Since $e\in\lbrace1,\ldots,s-2^{h}\rbrace$, by complete induction on $e$:
    \begin{itemize}
        \item base case $e=1$ yield the following congruence:
            ...
            \begin{itemize}
                ...
                \item assume $s$ odd, therefore both $s-1$ both $s+1$ are even, 
                    ...
                    $s=(\underbrace{1,1,1,\ldots,1}_{h+1})_{2}=2^{h+1}-1$ raises a contraddiction, since
                    ...
                    which cannot be the case.  Adding $1$ yield the representation
