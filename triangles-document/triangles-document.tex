    ...
    \begin{itemize}
        ...
        \item it provides a ``factorization'' of function $A(t)$ with coefficients
            ...
            \begin{displaymath}
                ...
                \left.\left[
                    (2+y)(1+y) =  (1+y)\Omega_{1}(y) + y\,\Delta_{1}(y)
                     \right| y = \replaced{h_{\mathcal{P}}}{h}(t) \right]
                 }
            \end{displaymath}
            ...
            \begin{lenghtydisplaymath}
                ...
                \end{split} 
            \end{lenghtydisplaymath}
            \added{dividing $(2+3y+2y^2+y^3)(1+y+y^2)$ by $y$ yield 
            $\Delta_{1}(y)=5+7y+6y^2+3y^3+y^4$ and 
                $(1+y+y^2)\Omega_{1}(y)=2$, this define polynomial $\Omega_{1}$.} 
            \added{By induction, repeated application of \emph{division theorem}
            yield the definition for the generic polynomial $\Omega_{i}$:}
            \begin{displaymath} 
                \added{\Omega_{i}(y)=\frac{1+i}{1+y+y^2}}
            \end{displaymath} 
