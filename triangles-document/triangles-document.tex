...
\begin{document}
    ...
    \begin{lemma}
        ...
        over rows of a Pascal array $\mathcal{P}$, such that $p^{m} \leq n < p^{m+1}$,
        and $k$ index over columns such that $k\in\lbrace0,\ldots,n-p^{m}\rbrace$, 
    ...
    \begin{proof} % $n+\gamma p^{m+1}$
        By the basis representation theorem, since $n<p^{m+1}$, write it in base $p$ as:
        \begin{displaymath}
            n = n_{0} + n_{1}p + n_{2}p^2 + \ldots + n_{m}p^m %+ 0p^{m+1} + \ldots + 0p^k
        \end{displaymath}
        similarly, since $n=p^{m}\rightarrow k\in\lbrace0\rbrace$ and 
        $n=p^{m+1}-1 \rightarrow k\in\lbrace 0,\ldots,p^{m}(p-1)-1\rbrace$, write $k$ as:
        \begin{displaymath}
            k = k_{0} + k_{1}p + k_{2}p^2 + \ldots + k_{m}p^m %+ 0p^{m+1} + \ldots + 0p^k
        \end{displaymath}
        apply Lucas theorem:
        \begin{displaymath}
            {{n+\gamma p^{m+1}} \choose { k+\gamma p^{m+1}}} \equiv_{p} 
                {{n_{0}} \choose {k_{0}}}  
                {{n_{1}} \choose {k_{1}}} 
                {{n_{2}} \choose {k_{2}}}
                \ldots
                {{n_{m-1}} \choose {k_{m-1}} }
                {{n_{m}} \choose {k_{m}} }
                {{\gamma} \choose {\gamma}} 
                \equiv_{p}{{n} \choose {k}}  
        \end{displaymath}
    ...
    \begin{displaymath}
        \begin{split}
            \hat{d}_{n,k} &\equiv_{p} \hat{d}_{n+\gamma p^{m+1}, k+\gamma p^{m+1}} \\
            (-1)^{n-k}d_{n,k} &\equiv_{p} (-1)^{n+\gamma p^{m+1}-(k+\gamma p^{m+1})}d_{n+\gamma p^{m+1}, k+\gamma p^{m+1}} \\
            (-1)^{n-k}d_{n,k} &\equiv_{p} (-1)^{n-k}d_{n+\gamma p^{m+1}, k+\gamma p^{m+1}} \\
        \end{split}
    \end{displaymath}
