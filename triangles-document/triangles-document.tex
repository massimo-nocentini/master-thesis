...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item it provides a ``factorization'' of function $A(t)$ with coefficients
            ...
            For the sake of clarity, consider Pascal array $\mathcal{P}$
            \replaced{and recall the following facts:}{
            ...
            \begin{displaymath}
                ...
                \Omega_{1}}(y) \right| y = h(t) \right]
            \end{displaymath}
            dividing $(1+y)^2$ by $y$ yield \replaced{$\Delta_{0}$}{
                $\Omega_{1}$}$(y)=2+y$ and $(1+y)\Omega_{0}(y)=1$ \added{, 
                this define polynomial $\Omega_{0}$}. 
                \added{We need to 
                keep applying \emph{division theorem}, so there exist polynomials 
                $\Omega_{1}$ and $\Delta_{1}$ such that:}
            \begin{displaymath}
                \added{
                \left.\left[
                    (2+y)(1+y) =  (1+y)\Omega_{1}(y) + y\,\Delta_{1}(y)
                     \right| y = h(t) \right]
                 }
            \end{displaymath}
            \added{dividing $(2+y)(1+y)$ by $y$ yield $\Delta_{1}(y)=3+y$ and 
                $(1+y)\Omega_{1}(y)=2$, this define polynomial $\Omega_{1}$.} 
            \added{By induction, repeated application of \emph{division theorem}
            yield the definition for the generic polynomial $\Omega_{i}$:}
            \begin{displaymath} 
                ...
                \replaced{
                    \left.\left[
                        A_{\mathcal{P}}(y) = \sum_{i \geq0}{\left(\frac{1+i}{1+y}\right)
                            \hat{h}_{\mathcal{P}}(y)^{i}} \right| y = h(t) \right]
                }{
                    \left.\left[
            ...
            the factorization of itself, pretty curious.}
