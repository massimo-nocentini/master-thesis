...
\begin{document}
    ...
    \subsection{Motzkin}
    Let $\mathcal{M}$ be the Riordan array for the Motzkin triangle, 
    variant $\mathcal{T}$, defined as:
    \begin{displaymath} 
        \mathcal{M} = \left(\frac{1}{\sqrt{1-2t-3t^2}}, 
    ...
    \begin{displaymath} 
        \mathcal{M}_{y=h(t)-1}\left( \frac{3+3y+y^2}{2y+y^2}, 1+y \right) = 
            \mathcal{M}_{h(t)}\left( \frac{1+h(t)+h(t)^2}{h(t)^2 -1}, h(t) \right) 
    \end{displaymath} 
    Now study the generating function which carries coefficients lying on column $k$
    of $\mathcal{M}_{h(t)}$:
    \begin{displaymath} 
