...
\begin{document}
    ...
    \added[id=sid]{In this section we offer an hint to tackle question number $1$
    ...
    following expansion defines a sequence $\lbrace d_{i}\rbrace_{i\in\mathbb{N}}$:
    \begin{displaymath}
        \frac{1-\sqrt{1-4\,t}}{2} = t + t^{2} + 2 t^{3} + 5 t^{4} 
            + 14 t^{5} + 42 t^{6} + 132 t^{7} + 429 t^{8} + 1430 t^{9} 
            + \mathcal{O}\left(t^{10}\right)
    \end{displaymath}
    where $d_{0}=0$. On the other hand the following one, defines a sequence 
    ...
    \begin{displaymath}
        {{2j}\choose{j}}
            \equiv_{2} {{0}\choose{j_{0}}}{{j_{0}}\choose{j_{1}}}{{j_{1}}\choose{j_{2}}}
                \ldots{{j_{k-1}}\choose{j_{k}}}{{j_{k}}\choose{0}}
    \end{displaymath}
    cleaning out coefficient on the very right, always equal to $1$, we get:
    \begin{displaymath}
        c_{j} \equiv_{2} \frac{1}{j+1}{{0}\choose{j_{0}}}{{j_{0}}\choose{j_{1}}}{{j_{1}}\choose{j_{2}}}
                \ldots{{j_{k-1}}\choose{j_{k}}}
    \end{displaymath}
    A first observation arises looking at the coefficient on the very left:
    \begin{displaymath}
        {{0}\choose{j_{0}}} = 0 \leftrightarrow j_{0} = 1
    \end{displaymath}
    therefore an interesting consequent, let $\alpha\in\mathbb{N}$:
    \begin{displaymath}
        c_{2\alpha+1} \equiv_{2} 0 
    \end{displaymath}
    On the other hand, assume there exists $\alpha\in\mathbb{N}$ such
    that $j=2\alpha$, therefore:
    \begin{displaymath}
        c_{2\alpha} \equiv_{2} {{j_{0}}\choose{j_{1}}}{{j_{1}}\choose{j_{2}}}
                \ldots{{j_{k-1}}\choose{j_{k}}}
    \end{displaymath}
    because $(j+1)\,c_{j}={{2j}\choose{j}}$ and $j+1\equiv_{2}2\,\alpha+1\equiv_{2}1$.

    In order to better understand the previous statements, here
    we supply a short table about, studying coefficient $d_{n,0}\in\mathcal{C}$,
    lying on the very first column:
    \begin{displaymath}
        \begin{split}
            d_{0,0} &= \sum_{i_{1}=1}{c_{i_{1}}} = c_{1}\equiv_{2}0 \\
            d_{1,0} &= \sum_{i_{1}=2}{c_{i_{1}}} = c_{2}
                \equiv_{2}{{j_{0}}\choose{j_{1}}} \equiv_{2}{{0}\choose{1}}\equiv_{2}0\\
            d_{2,0} &= \sum_{i_{1}=3}{c_{i_{1}}} = c_{3}\equiv_{2}0\\
            d_{3,0} &= \sum_{i_{1}=4}{c_{i_{1}}} = c_{4}
                \equiv_{2}{{j_{0}}\choose{j_{1}}} {{j_{1}}\choose{j_{2}}}
                \equiv_{2}{{0}\choose{0}} {{0}\choose{1}}\equiv_{2}0\\
            d_{4,0} &= \sum_{i_{1}=5}{c_{i_{1}}} = c_{5}\equiv_{2}0\\
            d_{5,0} &= \sum_{i_{1}=6}{c_{i_{1}}} = c_{6}
                \equiv_{2}{{j_{0}}\choose{j_{1}}} {{j_{1}}\choose{j_{2}}}
                \equiv_{2}{{0}\choose{1}} {{1}\choose{1}}\equiv_{2}0\\
            d_{6,0} &= \sum_{i_{1}=7}{c_{i_{1}}} = c_{7}\equiv_{2}0\\
            d_{7,0} &= \sum_{i_{1}=8}{c_{i_{1}}} = c_{8}
                \equiv_{2}{{j_{0}}\choose{j_{1}}} {{j_{1}}\choose{j_{2}}}{{j_{2}}\choose{j_{3}}}
                \equiv_{2}{{0}\choose{0}} {{0}\choose{0}}{{0}\choose{1}}\equiv_{2}0\\
        \end{split}
    \end{displaymath}
