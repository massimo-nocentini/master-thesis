...
\begin{figure}[H]
    ...
    \noindent\makebox[\textwidth]{
        ...
        \includegraphics[width=15cm, height=15cm, keepaspectratio=true]{../sympy/pascal/pascal-standard-ignore-negatives-centered-colouring-127-rows-multiples-of-3-partitioning-triangle.pdf}
    }
