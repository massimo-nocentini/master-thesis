...
\begin{figure}[p]
    ...
    \noindent\makebox[\textwidth]{
        ...
        \includegraphics[width=20cm, height=20cm, keepaspectratio=true]{../sympy/catalan/catalan-traditional-inverse-handle-negatives-centered-colouring-127-rows-multiples-of-11-partitioning-triangle.pdf}
    }
    ...
    \caption[${\left(\mathcal{C}^{-1}\right)}_{\stackrel{\circ}{\equiv_{11}}}$]
        {${\left(\mathcal{C}^{-1}\right)}_{\stackrel{\circ}{\equiv_{11}}}$ }

    \label{fig:catalan-traditional-inverse-handle-negatives-centered-colouring-127-rows-multiples-of-11-partitioning-triangle}
