...
\begin{figure}[H]
    ...
    \noindent\makebox[\textwidth]{
        ...
        \includegraphics[width=20cm, height=20cm, keepaspectratio=true]{../sympy/fibonacci/fibonacci-inverse-handle-negatives-centered-colouring-127-rows-multiples-of-7-partitioning-triangle.pdf}
    }
    ...
    \caption[$\left(\mathcal{F}^{-1}\right)_{\stackrel{\circ}{\equiv_{7}}}$]{ $\left(\mathcal{F}^{-1}\right)_{\stackrel{\circ}{\equiv_{7}}}$ }

    \label{fig:fibonacci-inverse-handle-negatives-centered-colouring-127-rows-multiples-of-7-partitioning-triangle}
