...
formally: \marginpar{\ac{fps} over a sequence $\vect{\omega}$ by Taylor expansion of \ac{gf} $\Omega$}
\begin{equation}
...
\marginpar{\ac{fps} convergence doesn't matter} \autoref{eq:fps:formally},
