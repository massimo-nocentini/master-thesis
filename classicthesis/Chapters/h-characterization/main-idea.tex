...
\end{itemize}
\marginpar{$\mathcal{R}_{t}(d(t),h(t))$ denotes verbosly, but correctly, $\mathcal{R}(d(t),h(t))$ }
...
\marginpar{we could stop and reason by cases about $\pm\left(\left(y + 2\right) y\right)$
    without going on substituting variable $y$\ldots}
\begin{lenghtydisplaymath} 
...
\marginpar{the converse is true indeed}
