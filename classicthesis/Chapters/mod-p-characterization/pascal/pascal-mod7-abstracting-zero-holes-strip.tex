...
%    plus/.style={text=links,font=\footnotesize\bfseries\sffamily},
  ...
  % the following key `pascal-standard-ignore-negatives-centered-colouring-127-rows-multiples-of-7-partitioning-tikz-nodes.tex' is used as a template key
  % to allow Python to do string substitution
  \input{pascal-mod7-abstracting-zero-holes-strip-tikz}
\end{tikzpicture}
