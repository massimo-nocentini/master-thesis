...
\begin{proof}
  ...
  In order to formalize \marginpar{equivalent position within a \emph{nest} of
  triangles} the concept of \emph{equivalent positions} we introduce the following 
  objects: 
  \begin{itemize}
