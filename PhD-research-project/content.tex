...
Actually, the goal of this project is twofold. First, \marginpar{to find combinatorial
meanings and\ldots} we are interested in studying how such powerful techniques
...
aspect is concerned, and to data structures for the combinatorial one. % here France advice to substitute `one' with `aspect'. 
