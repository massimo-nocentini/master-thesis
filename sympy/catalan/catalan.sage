...
Riordan_array = RiordanArray(
    ...
    name='Catalan', math_name=r'\mathcal{C}') 
...
colouring = TriangleColouring(
    colouring_scheme="standard", centered=True, handle_negatives=False)
...
inverses_tex_files = build_tex_files_about_colouring(
    catalan_inverse, inverses_results, 
    colouring, partitioning, tex_parent_prefix)

write_tex_files("catalan-typesetting-commands.sh",
