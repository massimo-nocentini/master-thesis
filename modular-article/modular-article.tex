...
% the following package allows us to capitalize autorefs of sections, taken from:
% http://tex.stackexchange.com/questions/34155/autoref-does-not-capitalize-initial-character-in-sentence-when-referencing-labe
\usepackage{cleveref}
...
\begin{document}
    ...
    \author{Donatella Merlini and Massimo Nocentini\\
        ...
        %{\sl \href{mailto:donatella.merlini@unifi.it}{donatella.merlini@unifi.it}, 
